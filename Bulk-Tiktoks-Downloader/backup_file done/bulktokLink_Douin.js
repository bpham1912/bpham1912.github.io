...
async function main() {
  ...
  if (userLink.includes("user/")){
    ...
    console.log("Syntax error: \n\r use it like that: node bulktok https://www.douyin.com/user/profile")
    process.exit()
  }
 ...
 var urls = await page.evaluate(() => Array.from(document.querySelectorAll('div.UFuuTZ1P > ul.EZC0YBrG > li.Eie04v01 > a')).map((element) => element.href))
